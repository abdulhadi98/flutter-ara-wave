...
class PublicAssetModel extends AssetModel {
  ...
  factory PublicAssetModel.fromJson(Map<String, dynamic> json) =>
      PublicAssetModel(
        id: json["id"] == null ? null : json["id"],
        // "primary_exchange": primaryExchange == null ? null : id,
        primaryExchange:
        ...
        assetTypeId: json["public_asset_type_id"] == null
            ? null
            : json["public_asset_type_id"],
        assetSubTypeId: json["public_asset_sub_type_id"] == null
            ? null
            : json["public_asset_sub_type_id"],
        assetCategoryId: json["public_asset_category_id"] == null
            ? null
            : json["public_asset_category_id"],
        assetType: json["public_asset_type"] == null
            ? null
            : PrivateAssetType.fromJson(json["public_asset_type"]),
        assetSubType: json["public_asset_sub_type"] == null
            ? null
            : PrivateAssetSubType.fromJson(json["public_asset_sub_type"]),
        assetCategory: json["public_asset_category"] == null
            ? null
            : PrivateAssetCategory.fromJson(json["public_asset_category"]),
      );
