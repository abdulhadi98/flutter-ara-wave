...
class NewsListModel {
  ...
  factory NewsListModel.fromJson(Map<String, dynamic> json) => NewsListModel(
        news: List<NewsModel>.from(
            json["items"].map((x) => NewsModel.fromJson(x))),
      );
...
class NewsModel {
  ...
  factory NewsModel.fromJson(Map<String, dynamic> json) => NewsModel(
        ...
        formattedDescription: json["formattedDescription"] == null
            ? null
            : json["formattedDescription"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "formattedDescription":
            formattedDescription == null ? null : formattedDescription,
