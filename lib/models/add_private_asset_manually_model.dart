...
class AddPrivateAssetManuallyModel extends BaseAddPrivateAssetManuallyModel {
  ...
  AddPrivateAssetManuallyModel({
    ...
    required String marketValue,
          ...
          country: country,
          yearOfInvestment: yearOfInvestment + '-01-01',
...
class PrivateAssetManuallyModel extends BaseAddPrivateAssetManuallyModel {
  ...
  factory PrivateAssetManuallyModel.fromJson(Map<String, dynamic> json) =>
      PrivateAssetManuallyModel(
        ...
        sharesPurchased:
            json["shares_purchased"] == null ? null : json["shares_purchased"],
        ...
        purchasedPrice: json["purchased_price"] == null
            ? null
            : double.parse(json["purchased_price"].toString()),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "shares_outstanding":
            companySharesOutstanding == null ? null : companySharesOutstanding,
        "market_value": privateAssetManuallyModelMarketValue == null
            ? null
            : privateAssetManuallyModelMarketValue,
        ...
        "returnOnInvestment":
            returnOnInvestment == null ? null : returnOnInvestment,
        "marketCapitalization":
            marketCapitalization == null ? null : marketCapitalization,
