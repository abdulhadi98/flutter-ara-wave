...
class BasePrivateManualModel extends HoldingModel {
  BasePrivateManualModel({
    required purchasedPrice,
    required quantity,
    required this.headquarterCity,
    required this.country,
...
class AddPrivateManualModel extends BasePrivateAssetHoldingModel {

  AddPrivateManualModel({
    required this.apiToken,
    required this.source,
    required this.purchasedAt,
    required purchasedPrice,
