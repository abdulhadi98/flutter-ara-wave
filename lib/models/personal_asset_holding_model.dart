...
class PersonalAssetHoldingModel {
  ...
  factory PersonalAssetHoldingModel.fromJson(Map<String, dynamic> json) =>
      PersonalAssetHoldingModel(
        ...
        personalAssetType: json["personal_asset_type"] == null
            ? null
            : PersonalAssetTypeModel.fromJson(json["personal_asset_type"]),
        personalAssetPhotos: json["personal_asset_photos"] == null
            ? null
            : personalAssetPhotosFromJson(json["personal_asset_photos"]!),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "personal_asset_type":
            personalAssetType == null ? null : personalAssetType!.toJson(),
        "personal_asset_photos": personalAssetPhotos == null
            ? null
            : personalAssetPhotosToJson(personalAssetPhotos!),
      };
}

List<PersonalAssetPhotos> personalAssetPhotosFromJson(str) =>
    List<PersonalAssetPhotos>.from(
        str.map((x) => PersonalAssetPhotos.fromJson(x)));
String personalAssetPhotosToJson(List<PersonalAssetPhotos> data) =>
...
class PersonalAssetPhotos {
  ...
  factory PersonalAssetPhotos.fromJson(Map<String, dynamic> json) =>
      PersonalAssetPhotos(
        id: json["id"] == null ? null : json["id"],
