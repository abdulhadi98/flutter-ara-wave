...
class PrivateAssetModel extends AssetModel {
  ...
  Map<String, List<T>> groupBy<T>(
      Map<String, List<T>> map, T element, String key) {
  ...
  factory PrivateAssetModel.fromJson(Map<String, dynamic> json) =>
      PrivateAssetModel(
        kind: 'holding',
        ...
        assetTypeId: json["private_asset_type_id"] == null
            ? null
            : json["private_asset_type_id"],
        assetSubTypeId: json["private_asset_sub_type_id"] == null
            ? null
            : json["private_asset_sub_type_id"],
        assetCategoryId: json["private_asset_category_id"] == null
            ? null
            : json["private_asset_category_id"],
        ...
        assetSubType: json["private_asset_sub_type"] == null
            ? null
            : PrivateAssetSubType.fromJson(json["private_asset_sub_type"]),
        assetCategory: json["private_asset_category"] == null
            ? null
            : PrivateAssetCategory.fromJson(json["private_asset_category"]),
        assetMetas: json["private_asset_metas"] == null
            ? null
            : List<PrivateAssetMeta>.from(json["private_asset_metas"]
                .map((x) => PrivateAssetMeta.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "private_asset_sub_type_id":
            assetSubTypeId == null ? null : assetSubTypeId,
        "private_asset_category_id":
            assetCategoryId == null ? null : assetCategoryId,
        ...
        "private_asset_sub_type":
            assetSubType == null ? null : assetSubType?.toJson(),
        "private_asset_category":
            assetCategory == null ? null : assetCategory?.toJson(),
        "private_asset_metas": assetMetas == null
            ? null
            : List<dynamic>.from(assetMetas!.map((x) => x.toJson())),
      };
}
...
class PrivateAssetMeta {
  ...
  factory PrivateAssetMeta.fromJson(Map<String, dynamic> json) =>
      PrivateAssetMeta(
        id: json["id"] == null ? null : json["id"],
        privateAssetId:
