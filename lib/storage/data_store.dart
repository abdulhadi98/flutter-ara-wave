...
class DataStore {
  ...
  Future<String?> getApiToken() async {
    ...
    //   ),
    // );
    HomeScreen.apiToken = _userModel!.apiToken!;
    print('hadi ' + _userModel!.apiToken!);
  ...
  List<PersonalAssetModel> getPersonalAssets() {
    ...
    List<ImageModel> icons = [
      ...
      ImageModel(
        url: 'assets/icons/ic_price_tag.svg',
        id: 4,
      ),
      ImageModel(
        url: 'assets/icons/ic_percentage.svg',
        id: 5,
      ),
    ];
    List<String> types = [
    ...
    List<ImageModel> collectableGallery = [
      ImageModel(
        url: 'assets/images/collectable_gallery_1.png',
        id: 1,
      ),
      ImageModel(
        url: 'assets/images/collectable_gallery_2.png',
        id: 2,
      ),
      ImageModel(
        url: 'assets/images/collectable_gallery_3.png',
        id: 3,
      ),
    ];
