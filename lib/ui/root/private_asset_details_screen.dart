...
import 'add_assets/custom_drop_down.dart';
...
class _PrivateAssetDetailsScreenState
  ...
  Widget buildPrivateAvailableCompanies() {
    return StreamBuilder<DataResource<List<PrivateAssetModel>>?>(
        stream: addPrivateSubscribedCompanyBloc.privateAssetsStream,
        builder: (context, assetsSnapshot) {
  ...
  Future<String> updateAsset(onUpdateOk) async {
    ...
    try {
      ...
      var response;
      var url = Uri.parse(
        'https://wave.aratech.co/api/edit-private-asset-holding',
      );
      print('///////////' +
          url.toString() +
          '//tokennnnnn///' +
      ...
      request.fields['private_asset_id'] = PublicAssetDetailsScreen.companyId;
  ...
  Future<String> deleteAsset(onUpdateOk) async {
    ...
    try {
      ...
      http.Response response = await http.delete(
        Uri.parse('https://wave.aratech.co/api/private-asset-holding/$assetId'),
        body: <String, String>{
          "api_token": apiToken!,
        },
      );
  ...
  Future<String> updatePriceHistory() async {
    ...
    try {
      ...
      request.fields['asset_type'] = 'private';
  ...
  void getAssetDetails() async {
    ...
    setState(() {
      ...
      companyName = payload['private_asset']['name'];
  ...
  void getPersonalChartValue() async {
    ...
    payload.forEach((element) {
      ...
      print(acquisitionDate.year.toString() + '   ' + growth.toString());
